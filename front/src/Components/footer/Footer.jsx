...
const footerColumns = [
  {
    ...
    items: [
      { labelKey: "footer.aboutUs", href: "/contact" },
      { labelKey: "footer.careers", href: "#" },
      { labelKey: "footer.mediaCenter", href: "#" },
    ],
  },
  {
    title: "footer.support",
    items: [
      { labelKey: "footer.helpCenter", href: "/contact" },
      { labelKey: "footer.contactUs", href: "/contact" },
      { labelKey: "footer.reportAnIssue", href: "/contact" },
    ],
  },
  {
    title: "footer.business",
    items: [
      { labelKey: "footer.sellWithUs", href: "/contact" },
      { labelKey: "footer.partners", href: "#" },
      { labelKey: "footer.advertising", href: "#" },
    ],
  },
  {
    ...
    <footer>
      <div className="footer_content">
        ...
        <div className="footer_intro">
          ...
          <div className="social_links">
            ...
            <a href="#" className="social_link" aria-label="Twitter/X">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                ...
                {column.items.map((item) => (
                  <li key={item.labelKey}>
                    {item.href.startsWith("/") ? (
                      <NavLink to={item.href}>{t(item.labelKey, item.labelKey.split(".").pop())}</NavLink>
                    ) : (
                      <a href={item.href}>{t(item.labelKey, item.labelKey.split(".").pop())}</a>
                    )}
                  </li>
                ))}
              </ul>
      ...
      <div className="footer_bottom">
        <p>
          ...
          {" · "}
          <a href="#">{t("footer.termsOfService", "Terms of Service")}</a>
          {" · "}
