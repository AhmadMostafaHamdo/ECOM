...
const ReportsStats = ({ stats }) => {
  ...
  return (
    <div className="reports-stats-grid">
      ...
      <StatCard
        icon={Clock}
        label={t("admin.reports.status.pending")}
        value={stats.pending}
        color="#f59e0b"
      />
      <StatCard
        icon={Eye}
        label={t("admin.reports.status.reviewed")}
        value={stats.reviewed}
        color="#FF9500"
      />
      <StatCard
        icon={CheckCircle}
        label={t("admin.reports.status.resolved")}
        value={stats.resolved}
        color="#22c55e"
      />
      <StatCard
        icon={Package}
        label={t("admin.reports.productReports")}
        value={stats.productReports}
        color="#FFBF5C"
      />
      <StatCard
        icon={User}
        label={t("admin.reports.userReports")}
