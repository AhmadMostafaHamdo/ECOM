                        ...
                        <div className="cart-main">
                            <div className="cart-header">
                                <div className="header-content">
                                    ...
                                    <p className="cart-subtitle">{cartdata.length} {cartdata.length === 1 ? 'item' : 'items'} in your cart</p>
                                </div>
                                    ...
                                    <div key={item.id} className="cart-item" style={{ '--item-index': index }}>
                                        ...
                                        <div className="item-content">
                                            <div className="item-info">
                                                <h3 className="item-title">{item.title.longTitle}</h3>
                                                <p className="item-subtitle">{item.title.shortTitle}</p>
